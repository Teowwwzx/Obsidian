...
A slide warns managers about two extremes when they are trying to decide which eggs (tech) to focus on:
- **Narrow Scope (太窄):** If focus only on one tiny niche, the risk of company's skills becoming obsolete (过时) if a new tech suddenly replaces that niche.
...
- Appropriating gains: Often the most difficult hurdle. Sometime no guarantee the value created will go to innovator without a strategy patent, secrecy, complementary assets / control of assets and lead time. If not the firm might watch the rivals steal the profits.