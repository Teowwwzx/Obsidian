...
| GenerationType.AUTO     | Old version of Hibernate<br>`IDENTITY`<br><br>New version of Hibernate<br>`SEQUENCE`<br><br>MySQL x support Sequence object (newest version supported, but seldom use)<br><br>Hibernate simulate sequence will create a table `hibernate_sequence` for storing ID<br><br>**Cons:**<br>**2 actions when inserting data:**<br>Hibernate have to modify `hibernate_sequence` table first every time inserting data -> then only modify actual table |         |
|                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                  |         |
|                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                  |         |
